...
# @class_declaration flcolagedo_gd_config #
class flcolagedo_gd_config(interna_gd_config, helpers.MixinConAcciones):
    pass
...
class gd_config(flcolagedo_gd_config, helpers.MixinConAcciones):
    pass
